        ...
        var moveSquare = function(){
        	...
        	if (endGame){
                ...
                if(counter > 1){
                    ...
                    confirm("You have made  1 click in 10 seconds!")
                }
                else {
                    confirm("You didnt make any clicks in 10 seconds! Better luck next time!")}; 
